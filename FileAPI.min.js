...
v=a.document,d=a.dataURLtoBlob,h={},O=/img/i,H=/canvas/i,I=/img|canvas/,E=/input/i,P=/^data:[^,]+,/,J=Math.pow,B={},D=[],F="abort progress error load loadend",Q="status statusText readyState response responseXML responseText responseBody".split(" "),i={build:3,cors:!1,debug:!1,pingUrl:location.protocol+"//"+location.host,staticPath:"./",KB:1024,MB:J(1024,2),GB:J(1024,3),TB:J(1024,4),expando:"fileapi"+ +new Date,uid:function(b){return b?b[i.expando]=b[i.expando]||i.uid():i.expando+ ++A},log:function(){i.debug&&
(a.console&&console.log)&&(console.log.apply?console.log.apply(console,arguments):console.log([].join.call(arguments," ")))},getXHR:function(){var b;if(a.XMLHttpRequest)b=new XMLHttpRequest;else if(a.ActiveXObject)try{b=new ActiveXObject("MSXML2.XMLHttp.3.0")}catch(d){}return b},isArray:w,support:{dnd:C&&"ondrop"in v.createElement("div"),cors:C,html5:l,dataURI:!0},event:{on:n,off:m,one:f,fix:z},throttle:function(b,d){var c,x,h;return function M(){x=arguments;h=!0;c||(h?(b.apply(a,x),h=!1,c=setTimeout(M,
d)):c=null)}},F:function(){},parseJSON:function(b){return a.JSON&&JSON.parse?JSON.parse(b):(new Function("return ("+b.replace(/([\r\n])/g,"\\$1")+");"))()},trim:function(b){b=String(b);return b.trim?b.trim():b.replace(/^\s+|\s+$/g,"")},queue:function(b){var d=0,a=0,c=!1,h=!1,j={inc:function(){a++},next:function(){d++;setTimeout(j.check,0)},check:function(){d>=a&&!c&&j.end()},isFail:function(){return c},fail:function(){!c&&b(c=!0)},end:function(){h||(h=!0,b())}};return j},each:g,afor:function(b,d){var a=
0,c=b.length;w(b)&&c--?function y(){d(c!=a&&y,b[a],a++)}():d(!1)},extend:function(b){g(arguments,function(d){g(d,function(d,a){b[a]=d})});return b},isFile:function(b){return l&&b&&b instanceof q},isCanvas:function(b){return b&&H.test(b.nodeName)},getFilesFilter:function(b){return(b="string"==typeof b?b:b.getAttribute&&b.getAttribute("accept")||"")?RegExp("("+b.replace(/\./g,"\\.").replace(/,/g,"|")+")$","i"):/./},readAsDataURL:function(b,d){i.isCanvas(b)?c(b,d,"load",i.toDataURL(b)):e(b,d,"DataURL")},
readAsBinaryString:function(b,d){s&&s.prototype.readAsBinaryString?e(b,d,"BinaryString"):e(b,function(b){if("load"==b.type)try{b.result=i.toBinaryString(b.result)}catch(a){b.type="error",b.message=a.toString()}d(b)},"DataURL")},readAsArrayBuffer:function(b,d){e(b,d,"ArrayBuffer")},readAsText:function(b,d,a){a||(a=d,d="utf-8");e(b,a,"Text",d)},toDataURL:function(b){if("string"==typeof b)return b;if(b.toDataURL)return b.toDataURL("image/png")},toBinaryString:function(b){return a.atob(i.toDataURL(b).replace(P,
""))},readAsImage:function(b,d,a){if(i.isFile(b))if(p){var h=p.createObjectURL(b);h===k?c(b,d,"error"):i.readAsImage(h,d,a)}else i.readAsDataURL(b,function(h){"load"==h.type?i.readAsImage(h.result,d,a):(a||"error"==h.type)&&c(b,d,h,null,{loaded:h.loaded,total:h.total})});else i.isCanvas(b)?c(b,d,"load",b):O.test(b.nodeName)?b.complete?c(b,d,"load",b):f(b,"error abort load",function y(a){"load"==a.type&&p&&p.revokeObjectURL(b.src);m(b,"error abort load",y);c(b,d,a,b)}):b.iframe?c(b,d,{type:"error"}):
(h=new Image,h.src=b.dataURL||b,i.readAsImage(h,d,a))},checkFileObj:function(b){var d={};"object"==typeof b?d=b:d.name=(b+"").split(/(\\|\/)/g).pop();d.type===k&&(d.type=d.name.split(".").pop());g(h,function(b,a){b.test(d.type)&&(d.type=a+"/"+d.type)});return d},getDropFiles:function(b,d){var a=[],c=(b.originalEvent||b||"").dataTransfer||{},h=w(c.items)&&c.items[0]&&j(c.items[0]),e=i.queue(function(){d(a)});g((h?c.items:c.files)||[],function(b){e.inc();if(h)u(b,function(b,d){!b&&a.push.apply(a,d);
e.next()});else{var d=function(d){d&&a.push(b);e.next()};if(!b.type&&0==b.size%4096&&102400>=b.size)if(s)try{var c=new s;f(c,F,function(b){b="error"!=b.type;d(b);b&&c.abort()});c.readAsDataURL(b)}catch(r){d(!1)}else d(null);else d(!0)}});e.check()},getFiles:function(b,d,a){var c=[];if(a)return i.filterFiles(i.getFiles(b),d,a),null;b.jquery&&(b.each(function(){c=c.concat(i.getFiles(this))}),b=c,c=[]);"string"==typeof d&&(d=i.getFilesFilter(d));b.originalEvent&&(b=z(b.originalEvent));b.dataTransfer?
b=b.dataTransfer:b.target&&(b=b.target);b.files?c=b.files:!l&&E.test(b&&b.tagName)?i.trim(b.value)&&(c=[i.checkFileObj(b.value)],c[0].blob=b,c[0].iframe=!0):w(b)&&(c=b);!d&&E.test(b&&b.tagName)&&(d=i.getFilesFilter(b));return i.filter(c,function(b){return!d||d.test(b.name)})},getInfo:function(b,d){var a={},c=D.concat();i.isFile(b)?function y(){var h=c.shift();h?h.test(b.type)?h(b,function(b,c){b?d(b):(i.extend(a,c),y())}):y():d(!1,a)}():d("not_support",a)},addInfoReader:function(b,d){d.test=function(d){return b.test(d)};
D.push(d)},addMime:function(b,d){h[b]=RegExp("("+d.replace(/,/g,"|")+")$","i")},filter:function(b,d){for(var a=[],c=0,h=b.length,j;c<h;c++)c in b&&(j=b[c],d.call(j,j,c,b)&&a.push(j));return a},filterFiles:function(b,d,a){if(b.length){var c=b.concat(),h,j=[],u=[];(function G(){c.length?(h=c.shift(),i.getInfo(h,function(b,a){(d(h,b?!1:a)?j:u).push(h);G()})):a(j,u)})()}else a([],b)},upload:function(b){var b=i.extend({beforeupload:i.F,upload:i.F,fileupload:i.F,fileprogress:i.F,filecomplete:i.F,progress:i.F,
complete:i.F},b),d=new i.XHR(b),a=this._getFilesDataArray(b.files),c=0,h=0,j=0,u=1;g(a,function(b){c+=b.size});d.total=c;d.loaded=0;b.beforeupload(d,b);(function G(){var e=a.shift(),w=this;d.currentFile=e;"abort"!=d.statusText&&e?this._getFormData(b,e,function(a){h||b.upload(d,b);var f=e.file,l=new i.XHR(i.extend({},b,{upload:function(){b.fileupload(f,l,b)},progress:function(a){a.lengthComputable&&(j=h+=~~(c*u*(a.loaded/a.total)-j+0.5),b.fileprogress(a,f,l,b),b.progress({type:a.type,total:c,loaded:d.loaded=
h,lengthComputable:!0},f,l,b))},complete:function(a){g(Q,function(b){d[b]=l[b]});d.loaded=h+=h-j+~~(c*u+0.5);b.filecomplete(a,l,f,b);G.call(w)}}));u=e.size/c;d.abort=function(){l.abort()};l.send(a)}):b.complete(200==d.status?!1:d.statusText||"error",d,b)}).call(this);return d},_getFilesDataArray:function(b){var d=[],a={};if(E.test(b&&b.tagName)){var c=i.getFiles(b);a[b.name||"file"]=null!==b.getAttribute("multiple")?c:c[0]}else w(b)&&E.test(b[0]&&b[0].tagName)?g(b,function(b){a[b.name||"file"]=i.getFiles(b)}):
a=b;g(a,function y(b,a){w(b)?g(b,function(b,d){y(b,a+"["+d+"]")}):b&&b.name&&d.push({name:a,file:b,size:b.size})});return d},_getFormData:function(b,a,c){var h=a.file,j=a.name,u=h.name,e=h.type,w=(a=i.support.transform&&b.imageTransform)&&"number"==typeof(a.maxWidth||a.minWidth||a.width),f=new i.Form,l=i.queue(function(){c(f)});a&&(/image/.test(h.type)||I.test(h.nodeType))?(l.inc(),w&&(a=[a]),i.Image.transform(h,a,function(a,c){w&&!a?(!d&&!i.flashEngine&&(c[0]=i.toBinaryString(c[0]),f.multipart=!0),
f.append(j,c[0],u,e)):(a||(g(c,function(b,a){!d&&!i.flashEngine&&(b=i.toBinaryString(b),f.multipart=!0);f.append(j+"["+a+"]",b,u,e)}),j+="[original]"),(a||b.imageOriginal)&&f.append(j,h,u,e));l.next()})):f.append(j,h,u);g(b.data,function R(b,d){"object"==typeof b?g(b,function(b,a){R(b,d+"["+a+"]")}):f.append(d,b)});l.check()},reset:function(b){var d,a;t?(a=t(b).clone(!0).insertBefore(b).val("")[0],t(b).remove()):(d=b.parentNode,a=d.insertBefore(b.cloneNode(!0),b),a.value="",d.removeChild(b),g(B[i.uid(b)],
function(d,c){g(d,function(d){m(b,c,d);n(a,c,d)})}));return a},load:function(b,d){var a=i.getXHR();a?(a.open("GET",b,!0),a.overrideMimeType&&a.overrideMimeType("text/plain; charset=x-user-defined"),n(a,"progress",function(b){b.lengthComputable&&d({type:b.type,loaded:b.loaded,total:b.total},a)}),a.onreadystatechange=function(){if(4==a.readyState)if(a.onreadystatechange=null,200==a.status){b=b.split("/");var c={name:b[b.length-1],size:a.getResponseHeader("Content-Length"),type:a.getResponseHeader("Content-Type")};
...
(function(a,k){var g=function(){},n=function(a){this.uid=k.uid();this.xhr={abort:g,getResponseHeader:g,getAllResponseHeaders:g};this.options=a};n.prototype={status:0,statusText:"",getResponseHeader:function(a){return this.xhr.getResponseHeader(a)},getAllResponseHeaders:function(){return this.xhr.getAllResponseHeaders()||{}},end:function(m,f){var c=this,e=c.options;c.abort=g;c.status=m;f&&(c.statusText=f);k.log("xhr.end:",m,f);e.complete(200==m?!1:c.statusText||"unknown",c);c.xhr&&c.xhr.node&&setTimeout(function(){var e=
...
a.getInfo(c,n.next)});n.check()}})}};a.Flash=l;var v=new Image;a.event.one(v,"error load",function(){a.support.dataURI=!(1!=v.width||1!=v.height);v=null;l.init()});v.src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw=="}})(FileAPI,window,document);"undefined"!==typeof ajs&&ajs.loaded&&ajs.loaded("{fileapi}FileAPI.min");"function"===typeof define&&define.amd&&define("FileAPI",[],function(){return window.FileAPI||{}});