...
k.appendChild(f),j.log(k.parentNode.innerHTML),document.body.appendChild(e),c.xhr.node=e,a[q]=function(a,f,g){c.readyState=4;c.responseText=g;c.end(a,f);e=null},c.readyState=2,k.submit(),k=null):this.xhr&&this.xhr.aborted?j.log("Error: already aborted"):(e=c.xhr=j.getXHR(),f.params&&(k+=(0>k.indexOf("?")?"?":"&")+f.params.join("&")),e.open("POST",k,!0),e.withCredentials="true",(!g.headers||!g.headers["X-Requested-With"])&&e.setRequestHeader("X-Requested-With","XMLHttpRequest"),j.each(g.headers,function(a,
