...
(function(a,k){function g(b,e,a){if(b)if(j(b))for(var c=0,d=b.length;c<d;c++)c in b&&e.call(a,b[c],c,b);else for(c in b)b.hasOwnProperty(c)&&e.call(a,b[c],c,b)}function q(b,e,a){if(b){var c=h.uid(b);C[c]||(C[c]={});g(e.split(/\s+/),function(e){t?t.event.add(b,e,a):(C[c][e]||(C[c][e]=[]),C[c][e].push(a),b.addEventListener?b.addEventListener(e,a,!1):b.attachEvent?b.attachEvent("on"+e,a):b["on"+e]=a)})}}function l(b,e,a){if(b){var c=h.uid(b),d=C[c]||{};g(e.split(/\s+/),function(e){if(t)t.event.remove(b,
e,a);else{for(var K=d[e]||[],c=K.length;c--;)if(K[c]===a){K.splice(c,1);break}b.addEventListener?b.removeEventListener(e,a,!1):b.detachEvent?b.detachEvent("on"+e,a):b["on"+e]=null}})}}function f(b,e,a){q(b,e,function S(c){l(b,e,S);a(c)})}function c(b,e,a,c,d){b={type:a.type||a,target:b,result:c};h.extend(b,d);e(b)}function d(b,e,a,O){if(h.isFile(b)&&u&&u.prototype["readAs"+a]){var d=new u;q(d,L,function T(a){var N=a.type;"progress"==N?c(b,e,a,a.target.result,{loaded:a.loaded,total:a.total}):"loadend"==
N?(l(d,L,T),d=null):c(b,e,a,a.target.result)});try{if(O)d["readAs"+a](O,b);else d["readAs"+a](b)}catch(j){c(b,e,"error",k,{error:j.toString()})}}else c(b,e,"error",k,{error:"filreader_not_support_"+a})}function m(b){var e;b.getAsEntry?e=b.getAsEntry():b.webkitGetAsEntry&&(e=b.webkitGetAsEntry());return e}function p(b,e){if(b)if(b.isFile)b.file(function(b){e(!1,[b])},function(){e("entry_file")});else if(b.isDirectory){var a=[];b.createReader().readEntries(function(b){h.afor(b,function(b,c){p(c,function(c,
d){c||(a=a.concat(d));b?b():e(!1,a)})})},function(){e("directory_reader")})}else p(m(b),e);else e("empty_entry")}function j(b){return"object"==typeof b&&b&&"length"in b}function A(b){b.target||(b.target=a.event&&a.event.srcElement||w);3===b.target.nodeType&&(b.target=event.target.parentNode);return b}var v=1,D=function(){},s=navigator.userAgent,x=a.createObjectURL&&a||a.URL&&URL.revokeObjectURL&&URL||a.webkitURL&&webkitURL,r=a.File,u=a.FileReader,n=a.FormData,t=a.jQuery,e=!(!r||!(u&&a.Uint8Array||
n))&&!(/safari\//.test(s)&&/windows/i.test(s)),s=e&&"withCredentials"in new XMLHttpRequest,n=e&&!!Blob&&!(!Blob.prototype.webkitSlice&&!Blob.prototype.mozSlice&&!Blob.prototype.slice),w=a.document,y=a.dataURLtoBlob,P={},E=/img/i,U=/canvas/i,V=/img|canvas/,G=/input/i,W=/^data:[^,]+,/,z=Math.pow,X=Math.round,H=Number,I=function(b){return X(b*this)},F=new H(1024),Q=new H(z(F,2)),J=new H(z(F,3)),z=new H(z(F,4)),C={},R=[],L="abort progress error load loadend",Y="status statusText readyState response responseXML responseText responseBody".split(" "),
h={version:"1.2.1",cors:!1,debug:!1,pingUrl:!1,staticPath:"./",flashUrl:0,flashImageUrl:0,chunkSize:0,chunkUploadRetry:0,KB:(F.from=I,F),MB:(Q.from=I,Q),GB:(J.from=I,J),TB:(z.from=I,z),expando:"fileapi"+(new Date).getTime(),uid:function(b){return b?b[h.expando]=b[h.expando]||h.uid():(++v,h.expando+v)},log:function(){h.debug&&(a.console&&console.log)&&(console.log.apply?console.log.apply(console,arguments):console.log([].join.call(arguments," ")))},getXHR:function(){var b;if(a.XMLHttpRequest)b=new XMLHttpRequest;
else if(a.ActiveXObject)try{b=new ActiveXObject("MSXML2.XMLHttp.3.0")}catch(e){}return b},isArray:j,support:{dnd:s&&"ondrop"in w.createElement("div"),cors:s,html5:e,chunked:n,dataURI:!0},event:{on:q,off:l,one:f,fix:A},throttle:function(b,e){var c,d;return function(){d=arguments;c||(b.apply(a,d),c=setTimeout(function(){c=0;b.apply(a,d)},e))}},F:function(){},parseJSON:function(b){return a.JSON&&JSON.parse?JSON.parse(b):(new Function("return ("+b.replace(/([\r\n])/g,"\\$1")+");"))()},trim:function(b){b=
String(b);return b.trim?b.trim():b.replace(/^\s+|\s+$/g,"")},defer:function(){var b=[],e,a,c={resolve:function(d,j){c.resolve=D;a=d||!1;for(e=j;j=b.shift();)j(a,e)},then:function(c){a!==k?c(a,e):b.push(c)}};return c},queue:function(b){var e=0,a=0,c=!1,d=!1,j={inc:function(){a++},next:function(){e++;setTimeout(j.check,0)},check:function(){e>=a&&!c&&j.end()},isFail:function(){return c},fail:function(){!c&&b(c=!0)},end:function(){d||(d=!0,b())}};return j},each:g,afor:function(b,e){var a=0,c=b.length;
j(b)&&c--?function B(){e(c!=a&&B,b[a],a++)}():e(!1)},extend:function(b){g(arguments,function(e){g(e,function(e,a){b[a]=e})});return b},isFile:function(b){return e&&b&&b instanceof r},isCanvas:function(b){return b&&U.test(b.nodeName)},getFilesFilter:function(b){return(b="string"==typeof b?b:b.getAttribute&&b.getAttribute("accept")||"")?RegExp("("+b.replace(/\./g,"\\.").replace(/,/g,"|")+")$","i"):/./},readAsDataURL:function(b,e){h.isCanvas(b)?c(b,e,"load",h.toDataURL(b)):d(b,e,"DataURL")},readAsBinaryString:function(b,
e){u&&u.prototype.readAsBinaryString?d(b,e,"BinaryString"):d(b,function(b){if("load"==b.type)try{b.result=h.toBinaryString(b.result)}catch(a){b.type="error",b.message=a.toString()}e(b)},"DataURL")},readAsArrayBuffer:function(b,e){d(b,e,"ArrayBuffer")},readAsText:function(b,e,a){a||(a=e,e="utf-8");d(b,a,"Text",e)},toDataURL:function(b){if("string"==typeof b)return b;if(b.toDataURL)return b.toDataURL("image/png")},toBinaryString:function(b){return a.atob(h.toDataURL(b).replace(W,""))},readAsImage:function(b,
e,a){if(h.isFile(b))if(x){var d=x.createObjectURL(b);d===k?c(b,e,"error"):h.readAsImage(d,e,a)}else h.readAsDataURL(b,function(d){"load"==d.type?h.readAsImage(d.result,e,a):(a||"error"==d.type)&&c(b,e,d,null,{loaded:d.loaded,total:d.total})});else h.isCanvas(b)?c(b,e,"load",b):E.test(b.nodeName)?b.complete?c(b,e,"load",b):f(b,"error abort load",function B(a){"load"==a.type&&x&&x.revokeObjectURL(b.src);l(b,"error abort load",B);c(b,e,a,b)}):b.iframe?c(b,e,{type:"error"}):(d=new Image,d.src=b.dataURL||
b,h.readAsImage(d,e,a))},checkFileObj:function(b){var e={};"object"==typeof b?e=b:e.name=(b+"").split(/(\\|\/)/g).pop();e.type===k&&(e.type=e.name.split(".").pop());g(P,function(b,a){b.test(e.type)&&(e.type=a+"/"+e.type)});return e},getDropFiles:function(b,e){var a=[],c=(b.originalEvent||b||"").dataTransfer||{},d=j(c.items)&&c.items[0]&&m(c.items[0]),w=h.queue(function(){e(a)});g((d?c.items:c.files)||[],function(b){w.inc();if(d)p(b,function(b,e){!b&&a.push.apply(a,e);w.next()});else{var e=function(e){e&&
a.push(b);w.next()};if(!b.type&&0==b.size%4096&&102400>=b.size)if(u)try{var c=new u;f(c,L,function(b){b="error"!=b.type;e(b);b&&c.abort()});c.readAsDataURL(b)}catch(j){e(!1)}else e(null);else e(!0)}});w.check()},getFiles:function(b,a,c){var d=[];if(c)return h.filterFiles(h.getFiles(b),a,c),null;b.jquery&&(b.each(function(){d=d.concat(h.getFiles(this))}),b=d,d=[]);"string"==typeof a&&(a=h.getFilesFilter(a));b.originalEvent?b=A(b.originalEvent):b.srcElement&&(b=A(b));b.dataTransfer?b=b.dataTransfer:
b.target&&(b=b.target);b.files?d=b.files:!e&&G.test(b&&b.tagName)?h.trim(b.value)&&(d=[h.checkFileObj(b.value)],d[0].blob=b,d[0].iframe=!0):j(b)&&(d=b);!a&&G.test(b&&b.tagName)&&(a=h.getFilesFilter(b));return h.filter(d,function(b){return!a||a.test(b.name)})},getInfo:function(b,e){var a={},c=R.concat();h.isFile(b)?function B(){var d=c.shift();d?d.test(b.type)?d(b,function(b,c){b?e(b):(h.extend(a,c),B())}):B():e(!1,a)}():e("not_support",a)},addInfoReader:function(b,e){e.test=function(e){return b.test(e)};
R.push(e)},addMime:function(b,e){P[b]=RegExp("("+e.replace(/,/g,"|")+")$","i")},filter:function(b,e){for(var a=[],c=0,d=b.length,j;c<d;c++)c in b&&(j=b[c],e.call(j,j,c,b)&&a.push(j));return a},filterFiles:function(b,e,a){if(b.length){var c=b.concat(),d,j=[],w=[];(function M(){c.length?(d=c.shift(),h.getInfo(d,function(b,a){(e(d,b?!1:a)?j:w).push(d);M()})):a(j,w)})()}else a([],b)},upload:function(b){b=h.extend({prepare:h.F,beforeupload:h.F,upload:h.F,fileupload:h.F,fileprogress:h.F,filecomplete:h.F,
progress:h.F,complete:h.F,chunkSize:h.chunkSize,chunkUpoloadRetry:h.chunkUploadRetry},b);b.imageAutoOrientation&&!b.imageTransform&&(b.imageTransform={rotate:"auto"});var e=new h.XHR(b),a=this._getFilesDataArray(b.files),c=0,d=0,j=0,w=1;g(a,function(b){c+=b.size});e.files=[];g(a,function(b){e.files.push(b.file)});e.total=c;e.loaded=0;b.beforeupload(e,b);(function M(){var p=a.shift(),f=this,y=p&&p.file,m=!1,v={};g(b,function(b,e){b&&"object"===typeof b&&(b=h.extend({},b));v[e]=b});"abort"!=e.statusText&&
p?(e.currentFile=y,b.prepare(y,v),this._getFormData(v,p,function(a){d||b.upload(e,b);var l=new h.XHR(h.extend({},v,{upload:function(){b.fileupload(y,l,v)},progress:function(a){m||(j=d+=c*w*(a.loaded/a.total)-j+0.5|0,p.total=a.total,p.loaded=a.loaded,b.fileprogress(a,y,l,v),b.progress({type:a.type,total:c,loaded:e.loaded=d,lengthComputable:!0},y,l,v))},complete:function(a){g(Y,function(b){e[b]=l[b]});m=!0;p.loaded=p.total;e.loaded=d+=d-j+(c*w+0.5)|0;b.filecomplete(a,l,y,v);M.call(f)}}));w=p.size/c;
e.abort=function(){l.abort()};l.send(a)})):b.complete(200==e.status?!1:e.statusText||"error",e,b)}).call(this);return e},_getFilesDataArray:function(b){var e=[],a={};if(G.test(b&&b.tagName)){var c=h.getFiles(b);a[b.name||"file"]=null!==b.getAttribute("multiple")?c:c[0]}else j(b)&&G.test(b[0]&&b[0].tagName)?g(b,function(b){a[b.name||"file"]=h.getFiles(b)}):a=b;g(a,function B(b,a){j(b)?g(b,function(b,e){B(b,a+"["+e+"]")}):b&&b.name&&e.push({name:a,file:b,size:b.size,total:b.size,loaded:0})});return e},
_getFormData:function(b,e,a){var c=e.file,d=e.name,j=c.name,w=c.type;e=h.support.transform&&b.imageTransform;var p=new h.Form,f=h.queue(function(){a(p)}),v=e&&(0<parseInt(e.maxWidth||e.minWidth||e.width,10)||e.rotate);h.Image&&e&&(/image/.test(c.type)||V.test(c.nodeType))?(f.inc(),v&&(e=[e]),h.Image.transform(c,e,b.imageAutoOrientation,function(e,a){v&&!e?(!y&&!h.flashEngine&&(a[0]=h.toBinaryString(a[0]),p.multipart=!0),p.append(d,a[0],j,w)):(e||(g(a,function(b,e){!y&&!h.flashEngine&&(b=h.toBinaryString(b),
p.multipart=!0);p.append(d+"["+e+"]",b,j,w)}),d+="[original]"),(e||b.imageOriginal)&&p.append(d,c,j,w));f.next()})):p.append(d,c,j);g(b.data,function Z(b,e){"object"==typeof b?g(b,function(b,a){Z(b,e+"["+a+"]")}):p.append(e,b)});f.check()},reset:function(b){var e,a;t?(a=t(b).clone(!0).insertBefore(b).val("")[0],t(b).remove()):(e=b.parentNode,a=e.insertBefore(b.cloneNode(!0),b),a.value="",e.removeChild(b),g(C[h.uid(b)],function(e,c){g(e,function(e){l(b,c,e);q(a,c,e)})}));return a},load:function(b,
e){var a=h.getXHR();a?(a.open("GET",b,!0),a.overrideMimeType&&a.overrideMimeType("text/plain; charset=x-user-defined"),q(a,"progress",function(b){b.lengthComputable&&e({type:b.type,loaded:b.loaded,total:b.total},a)}),a.onreadystatechange=function(){if(4==a.readyState)if(a.onreadystatechange=null,200==a.status){b=b.split("/");var c={name:b[b.length-1],size:a.getResponseHeader("Content-Length"),type:a.getResponseHeader("Content-Type")};c.dataURL="data:"+c.type+";base64,"+h.encode64(a.responseBody||
a.responseText);e({type:"load",result:c})}else e({type:"error"})},a.send(null)):e({type:"error"});return a},encode64:function(b){var e="",a=0;for("string"!==typeof b&&(b=String(b));a<b.length;){var c=b.charCodeAt(a++)&255,d=b.charCodeAt(a++)&255,j=b.charCodeAt(a++)&255,p=c>>2,c=(c&3)<<4|d>>4;isNaN(d)?d=j=64:(d=(d&15)<<2|j>>6,j=isNaN(j)?64:j&63);e+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(p)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(c)+
...
g&&f&&(a.rotate="auto");j.rotate(a.rotate);r.inc();j.toData(function(e,a){e?r.fail():(x[d]=a,r.next())})}})})};a.support.canvas=a.support.transform=c;a.Image=q})(FileAPI,document);
...
toPlainData:function(a){this._to({},a,function(a,d,f){a.file&&(d.type=a.file);a.blob.toBlob?(f.inc(),a.blob.toBlob(function(g){d.name=a.name;d.file=g;d.size=g.length;f.next()},"image/png")):a.file?(d.name=a.blob.name,d.file=a.blob,d.size=a.blob.size):(d.params||(d.params=[]),d.params.push(encodeURIComponent(a.name)+"="+encodeURIComponent(a.blob)));d.start=0;d.end=0;d.retry=0})},toFormData:function(a){this._to(new l,a,function(a,d,f){a.file&&d.append("_"+a.name,a.file);a.blob&&a.blob.toBlob?(f.inc(),
a.blob.toBlob(function(g){d.append(a.name,g,a.file);f.next()},"image/png")):a.file?d.append(a.name,a.blob,a.file):d.append(a.name,a.blob)})},toMultipartData:function(f){this._to([],f,function(a,d,f,g){d.push("--_"+g+('\r\nContent-Disposition: form-data; name="'+a.name+'"'+(a.file?'; filename="'+q(a.file)+'"':"")+(a.file?"\r\nContent-Type: "+(a.type||"application/octet-stream"):"")+"\r\n\r\n"+(a.file?a.blob:q(a.blob))+"\r\n"))},a.expando)}};a.Form=k})(FileAPI,window,document);
(function(a,k){var g=function(){},q=function(a){this.uid=k.uid();this.xhr={abort:g,getResponseHeader:g,getAllResponseHeaders:g};this.options=a};q.prototype={status:0,statusText:"",getResponseHeader:function(a){return this.xhr.getResponseHeader(a)},getAllResponseHeaders:function(){return this.xhr.getAllResponseHeaders()||{}},end:function(l,f){var c=this,d=c.options;c.end=c.abort=g;c.status=l;f&&(c.statusText=f);k.log("xhr.end:",l,f);d.complete(200==l?!1:c.statusText||"unknown",c);c.xhr&&c.xhr.node&&
...
function(a){g.progress({type:a.type,total:f.size,loaded:f.start+a.loaded,totalSize:f.size},c,g)},!1),d.onreadystatechange=function(){c.status=d.status;c.statusText=d.statusText;c.readyState=d.readyState;if(4==d.readyState){for(var a in{"":1,XML:1,Text:1,Body:1})c["response"+a]=d["response"+a];d.onreadystatechange=null;0<d.status-201?++f.retry<=g.chunkUploadRetry&&(500==d.status||416==d.status)?(f.end=f.start,c._send(g,f)):c.end(d.status):(f.retry=0,f.end==f.size-1?c.end(d.status):c._send(g,f));d=
null}},f.start=f.end,f.end=Math.min(f.end+g.chunkSize,f.size)-1,(m="slice")in f.file||(m="mozSlice")in f.file||(m="webkitSlice"),d.setRequestHeader("Content-Range","bytes "+f.start+"-"+f.end+"/"+f.size),d.setRequestHeader("Content-Disposition","attachment; filename="+encodeURIComponent(f.name)),m=f.file[m](f.start,f.end+1),d.send(m),m=null):(d.upload&&d.upload.addEventListener("progress",k.throttle(function(a){g.progress(a,c,g)},100),!1),d.onreadystatechange=function(){c.status=d.status;c.statusText=
d.statusText;c.readyState=d.readyState;if(4==d.readyState){for(var a in{"":1,XML:1,Text:1,Body:1})c["response"+a]=d["response"+a];d.onreadystatechange=null;c.end(d.status);d=null}},k.isArray(f)?(d.setRequestHeader("Content-Type","multipart/form-data; boundary=_"+k.expando),f=f.join("")+"--_"+k.expando+"--",d.sendAsBinary?d.sendAsBinary(f):(m=Array.prototype.map.call(f,function(a){return a.charCodeAt(0)&255}),d.send((new Uint8Array(m)).buffer))):d.send(f)))}};k.XHR=q})(window,FileAPI);
...
e:r[a.uid(e.target||e.srcElement||e)];if(!f)return this.parent.apply(this,arguments);c&&(c=a.getFilesFilter(c),f=a.filter(f,function(a){return c.test(a.name)}));return f},getInfo:function(a,c){if(a&&!a.flashId)this.parent.apply(this,arguments);else{if(!a.__info){var d=a.__info=FileAPI.defer();n.cmd(a,"getFileInfo",{id:a.id,callback:A(function E(c,f){v(E);d.resolve(c,a.info=f)})})}a.__info.then(c)}}});a.support.transform=!0;FileAPI.Image&&j(FileAPI.Image.prototype,{get:function(a,c){this.set({scaleMode:c||
"noScale"});this.parent(a)},_load:function(c,d){a.log("FileAPI.Image._load:",c);if(c&&!c.flashId)this.parent.apply(this,arguments);else{var f=this;a.getInfo(c,function(a){d.call(f,a,c)})}},_apply:function(c,d){a.log("FileAPI.Image._apply:",c);if(c&&!c.flashId)this.parent.apply(this,arguments);else{var f=this.getMatrix(c.info);n.cmd(c,"imageTransform",{id:c.id,matrix:f,callback:A(function E(j,k){a.log("FileAPI.Image._apply.callback:",j);v(E);if(j)d(j);else if(!a.support.dataURI||3E4<k.length){var l=
{width:!(f.deg%180)?f.dw:f.dh,height:f.deg%180?f.dw:f.dh,scale:f.scaleMode},q=d,s=function(){try{n.get(t).setImage(k)}catch(c){a.log('flash.setImage -- can not set "base64":',c)}},r,t=a.uid(),u=g.createElement("div");for(r in l)u.setAttribute("data-img-"+r,l[r]);p(u,l);u.innerHTML=m(a.extend({id:t,src:D(a.flashImageUrl,"r="+a.uid()),wmode:"opaque",flashvars:"scale="+l.scale+"&callback="+A(function J(){v(J);setTimeout(s,99);return!0})},l));q(!1,u);u=null}else{var x=new Image;a.event.one(x,"error abort load",
function(a){d("load"!=a.type&&a.type,x);x=null});x.src="data:"+c.type+";base64,"+k}})})}},toData:function(a){var c=this.file;c&&!c.flashId?this.parent.apply(this,arguments):a.call(this,!c.info,{id:c.id,flashId:c.flashId,name:c.name,type:c.type,matrix:this.getMatrix(c.info)})}});j(a.Form.prototype,{toData:function(c){for(var d=this.items,f=d.length;f--;)if(d[f].file&&d[f].blob&&!d[f].blob.flashId)return this.parent.apply(this,arguments);a.log("flash.Form.toData");c(d)}});j(a.XHR.prototype,{_send:function(c,
d){if(d.nodeName||d.append&&a.support.html5||a.isArray(d)&&"string"===typeof d[0])return this.parent.apply(this,arguments);var f={},g={},j=this,k,l;a.each(d,function(a){a.file?(g[a.name]=a={id:a.blob.id,name:a.blob.name,matrix:a.blob.matrix,flashId:a.blob.flashId},l=a.id,k=a.flashId):f[a.name]=a.blob});a.log("flash.XHR._send:",k,l,g);j.xhr={headers:{},abort:function(){n.cmd(k,"abort",l)},getResponseHeader:function(a){return this.headers[a]},getAllResponseHeaders:function(){return this.headers}};var m=
a.queue(function(){n.cmd(k,"upload",{url:D(c.url),data:f,files:g,headers:c.headers,callback:A(function z(d){var f=d.type,g=d.result;a.log("flash.upload."+f+":",d);if("progress"==f)d.loaded=Math.min(d.loaded,d.total),d.lengthComputable=!0,c.progress(d);else if("complete"==f)v(z),"string"==typeof g&&(j.responseText=g.replace(/%22/g,'"').replace(/%5c/g,"\\").replace(/%26/g,"&").replace(/%25/g,"%")),j.end(d.status||200);else if("abort"==f||"error"==f)j.end(d.status||0,d.message),v(z)})})});a.each(g,function(c){m.inc();
a.getInfo(c,m.next)});m.check()}})}};a.Flash=n;var t=new Image;a.event.one(t,"error load",function(){a.support.dataURI=!(1!=t.width||1!=t.height);t=null;n.init()});t.src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw=="}})(FileAPI,window,document);"undefined"!==typeof ajs&&ajs.loaded&&ajs.loaded("{fileapi}FileAPI.min");"function"===typeof define&&define.amd&&define("FileAPI",[],function(){return window.FileAPI||{}});