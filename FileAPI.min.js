...
(function(a,m){function g(b,t,d){if(b)if(w(b))for(var a=0,c=b.length;a<c;a++)a in b&&t.call(d,b[a],a,b);else for(a in b)b.hasOwnProperty(a)&&t.call(d,b[a],a,b)}function s(b,t,a){if(b){var d=k.uid(b);C[d]||(C[d]={});g(t.split(/\s+/),function(t){x?x.event.add(b,t,a):(C[d][t]||(C[d][t]=[]),C[d][t].push(a),b.addEventListener?b.addEventListener(t,a,!1):b.attachEvent?b.attachEvent("on"+t,a):b["on"+t]=a)})}}function p(b,t,a){if(b){var d=k.uid(b),c=C[d]||{};g(t.split(/\s+/),function(t){if(x)x.event.remove(b,
t,a);else{for(var d=c[t]||[],h=d.length;h--;)if(d[h]===a){d.splice(h,1);break}b.addEventListener?b.removeEventListener(t,a,!1):b.detachEvent?b.detachEvent("on"+t,a):b["on"+t]=null}})}}function f(b,t,d){s(b,t,function R(a){p(b,t,R);d(a)})}function c(b,t,d,a,c){b={type:d.type||d,target:b,result:a};k.extend(b,c);t(b)}function e(b,t,d,a){if(k.isFile(b)&&v&&v.prototype["readAs"+d]){var h=new v;s(h,L,function S(d){var a=d.type;"progress"==a?c(b,t,d,d.target.result,{loaded:d.loaded,total:d.total}):"loadend"==
a?(p(h,L,S),h=null):c(b,t,d,d.target.result)});try{if(a)h["readAs"+d](a,b);else h["readAs"+d](b)}catch(e){c(b,t,"error",m,{error:e.toString()})}}else c(b,t,"error",m,{error:"filreader_not_support_"+d})}function n(b,d){if(!b.type&&0==b.size%4096&&102400>=b.size)if(v)try{var a=new v;f(a,L,function(b){b="error"!=b.type;d(b);b&&a.abort()});a.readAsDataURL(b)}catch(c){d(!1)}else d(null);else d(!0)}function q(b){var d;b.getAsEntry?d=b.getAsEntry():b.webkitGetAsEntry&&(d=b.webkitGetAsEntry());return d}function r(b,
d){if(b)if(b.isFile)b.file(function(a){a.fullPath=b.fullPath;d(!1,[a])},function(){d("entry_file")});else if(b.isDirectory){var a=[];b.createReader().readEntries(function(b){k.afor(b,function(b,c){r(c,function(c,h){c||(a=a.concat(h));b?b():d(!1,a)})})},function(){d("directory_reader")})}else r(q(b),d);else d("empty_entry")}function w(b){return"object"==typeof b&&b&&"length"in b}function B(b){var d={};g(b,function(b,a){b&&"object"===typeof b&&(b=k.extend({},b));d[a]=b});return d}function D(b){b.target||
(b.target=a.event&&a.event.srcElement||A);3===b.target.nodeType&&(b.target=event.target.parentNode);return b}var l=1,d=function(){},h=navigator.userAgent,u=a.createObjectURL&&a||a.URL&&URL.revokeObjectURL&&URL||a.webkitURL&&webkitURL,E=a.Blob,F=a.File,v=a.FileReader,G=a.FormData,J=a.XMLHttpRequest,x=a.jQuery,y=!!(F&&v&&(a.Uint8Array||G||J.prototype.sendAsBinary))&&!(/safari\//i.test(h)&&!/chrome\//i.test(h)&&/windows/i.test(h)),h=y&&"withCredentials"in new J,E=y&&!!E&&!!(E.prototype.webkitSlice||
E.prototype.mozSlice||E.prototype.slice),A=a.document,N=a.dataURLtoBlob,V=/img/i,W=/canvas/i,X=/img|canvas/,M=/input/i,Y=/^data:[^,]+,/,H=Math.pow,Z=Math.round,K=Number,G=function(b){return Z(b*this)},I=new K(1024),O=new K(H(I,2)),P=new K(H(I,3)),H=new K(H(I,4)),C={},Q=[],L="abort progress error load loadend",$="status statusText readyState response responseXML responseText responseBody".split(" "),k={version:"1.2.6",cors:!1,html5:!0,debug:!1,pingUrl:!1,flashAbortTimeout:0,withCredentials:!0,staticPath:"./",
flashUrl:0,flashImageUrl:0,postNameConcat:function(b,d){return b+(null!=d?"["+d+"]":"")},ext2mime:{jpg:"image/jpeg",tif:"image/tiff"},accept:{"image/*":"art bm bmp dwg dxf cbr cbz fif fpx gif ico iefs jfif jpe jpeg jpg jps jut mcf nap nif pbm pcx pgm pict pm png pnm qif qtif ras rast rf rp svf tga tif tiff xbm xbm xpm xwd","audio/*":"m4a flac aac rm mpa wav wma ogg mp3 mp2 m3u mod amf dmf dsm far gdm imf it m15 med okt s3m stm sfx ult uni xm sid ac3 dts cue aif aiff wpl ape mac mpc mpp shn wv nsf spc gym adplug adx dsp adp ymf ast afc hps xs",
"video/*":"m4v 3gp nsv ts ty strm rm rmvb m3u ifo mov qt divx xvid bivx vob nrg img iso pva wmv asf asx ogm m2v avi bin dat dvr-ms mpg mpeg mp4 mkv avc vp3 svq3 nuv viv dv fli flv wpl"},chunkSize:0,chunkUploadRetry:0,chunkNetworkDownRetryTimeout:2E3,KB:(I.from=G,I),MB:(O.from=G,O),GB:(P.from=G,P),TB:(H.from=G,H),expando:"fileapi"+(new Date).getTime(),uid:function(b){return b?b[k.expando]=b[k.expando]||k.uid():(++l,k.expando+l)},log:function(){k.debug&&a.console&&console.log&&(console.log.apply?console.log.apply(console,
arguments):console.log([].join.call(arguments," ")))},newImage:function(b,d){var a=A.createElement("img");if(d)k.event.one(a,"error load",function(b){d("error"==b.type,a);a=null});a.src=b;return a},getXHR:function(){var b;if(J)b=new J;else if(a.ActiveXObject)try{b=new ActiveXObject("MSXML2.XMLHttp.3.0")}catch(d){b=new ActiveXObject("Microsoft.XMLHTTP")}return b},isArray:w,support:{dnd:h&&"ondrop"in A.createElement("div"),cors:h,html5:y,chunked:E,dataURI:!0},event:{on:s,off:p,one:f,fix:D},throttle:function(b,
d){var c,h;return function(){h=arguments;c||(b.apply(a,h),c=setTimeout(function(){c=0;b.apply(a,h)},d))}},F:function(){},parseJSON:function(b){return a.JSON&&JSON.parse?JSON.parse(b):(new Function("return ("+b.replace(/([\r\n])/g,"\\$1")+");"))()},trim:function(b){b=String(b);return b.trim?b.trim():b.replace(/^\s+|\s+$/g,"")},defer:function(){var b=[],a,c,h={resolve:function(e,f){h.resolve=d;c=e||!1;for(a=f;f=b.shift();)f(c,a)},then:function(d){c!==m?d(c,a):b.push(d)}};return h},queue:function(b){var d=
0,a=0,c=!1,h=!1,e={inc:function(){a++},next:function(){d++;setTimeout(e.check,0)},check:function(){d>=a&&!c&&e.end()},isFail:function(){return c},fail:function(){!c&&b(c=!0)},end:function(){h||(h=!0,b())}};return e},each:g,afor:function(b,d){var a=0,c=b.length;w(b)&&c--?function z(){d(c!=a&&z,b[a],a++)}():d(!1)},extend:function(b){g(arguments,function(d){g(d,function(d,a){b[a]=d})});return b},isFile:function(b){return y&&b&&b instanceof F},isCanvas:function(b){return b&&W.test(b.nodeName)},getFilesFilter:function(b){return(b=
...
readAsText:function(b,d,a){a||(a=d,d="utf-8");e(b,a,"Text",d)},toDataURL:function(b){if("string"==typeof b)return b;if(b.toDataURL)return b.toDataURL("image/png")},toBinaryString:function(b){return a.atob(k.toDataURL(b).replace(Y,""))},readAsImage:function(b,d,a){if(k.isFile(b))if(u){var h=u.createObjectURL(b);h===m?c(b,d,"error"):k.readAsImage(h,d,a)}else k.readAsDataURL(b,function(h){"load"==h.type?k.readAsImage(h.result,d,a):(a||"error"==h.type)&&c(b,d,h,null,{loaded:h.loaded,total:h.total})});
else k.isCanvas(b)?c(b,d,"load",b):V.test(b.nodeName)?b.complete?c(b,d,"load",b):f(b,"error abort load",function z(a){"load"==a.type&&u&&u.revokeObjectURL(b.src);p(b,"error abort load",z);c(b,d,a,b)}):b.iframe?c(b,d,{type:"error"}):(h=k.newImage(b.dataURL||b),k.readAsImage(h,d,a))},checkFileObj:function(b){var d={},a=k.accept;"object"==typeof b?d=b:d.name=(b+"").split(/\\|\//g).pop();null==d.type&&(d.type=d.name.split(".").pop());g(a,function(b,a){b=RegExp(b.replace(/\s/g,"|"),"i");b.test(d.type)&&
(d.type=k.ext2mime[d.type]||a.split("/")[0]+"/"+d.type)});return d},getDropFiles:function(b,d){var a=[],c=(b.originalEvent||b||"").dataTransfer||{},h=w(c.items)&&c.items[0]&&q(c.items[0]),e=k.queue(function(){d(a)});g((h?c.items:c.files)||[],function(b){e.inc();try{h?r(b,function(b,d){!b&&a.push.apply(a,d);e.next()}):n(b,function(d){d&&a.push(b);e.next()})}catch(d){e.next(),k.log("getDropFiles.error:",d.toString())}});e.check()},getFiles:function(b,d,a){var c=[];if(a)return k.filterFiles(k.getFiles(b),
d,a),null;b.jquery&&(b.each(function(){c=c.concat(k.getFiles(this))}),b=c,c=[]);"string"==typeof d&&(d=k.getFilesFilter(d));b.originalEvent?b=D(b.originalEvent):b.srcElement&&(b=D(b));b.dataTransfer?b=b.dataTransfer:b.target&&(b=b.target);b.files?(c=b.files,y||(c[0].blob=b,c[0].iframe=!0)):!y&&M.test(b&&b.tagName)?k.trim(b.value)&&(c=[k.checkFileObj(b.value)],c[0].blob=b,c[0].iframe=!0):w(b)&&(c=b);return k.filter(c,function(b){return!d||d.test(b.name)})},getInfo:function(b,d){var a={},c=Q.concat();
k.isFile(b)?function z(){var h=c.shift();h?h.test(b.type)?h(b,function(b,c){b?d(b):(k.extend(a,c),z())}):z():d(!1,a)}():d("not_support",a)},addInfoReader:function(b,d){d.test=function(d){return b.test(d)};Q.push(d)},filter:function(b,d){for(var a=[],c=0,h=b.length,e;c<h;c++)c in b&&(e=b[c],d.call(e,e,c,b)&&a.push(e));return a},filterFiles:function(b,d,a){if(b.length){var c=b.concat(),h,e=[],f=[];(function T(){c.length?(h=c.shift(),k.getInfo(h,function(b,a){(d(h,b?!1:a)?e:f).push(h);T()})):a(e,f)})()}else a([],
...
b);(u=function U(){var u=c.shift(),q=u&&u.file,l=!1,w=B(b);a.filesLeft=c.length;q&&q.name===k.expando&&(q=null,k.log("[warn] FileAPI.upload() \u2014 called without files"));("abort"!=a.statusText||a.current)&&u?(r=!1,(a.currentFile=q)&&b.prepare(q,w),this._getFormData(w,u,function(r){e||b.upload(a,b);var p=new k.XHR(k.extend({},w,{upload:q?function(){b.fileupload(q,p,w)}:d,progress:q?function(d){l||(b.fileprogress({type:"progress",total:u.total=d.total,loaded:u.loaded=d.loaded},q,p,w),b.progress({type:"progress",
total:h,loaded:a.loaded=e+u.size*(d.loaded/d.total)|0},q,p,w))}:d,complete:function(d){l=!0;g($,function(b){a[b]=p[b]});q&&(u.loaded=u.total,this.progress(u),e+=u.size,a.loaded=e,b.filecomplete(d,p,q,w));U.call(f)}}));a.abort=function(b){b||(c.length=0);this.current=b;p.abort()};p.send(r)})):(b.complete(200==a.status||201==a.status?!1:a.statusText||"error",a,b),r=!0)}).call(this);a.append=function(b,d){b=k._getFilesDataArray([].concat(b));g(b,function(b){h+=b.size;a.files.push(b.file);d?c.unshift(b):
c.push(b)});a.statusText="";r&&u.call(f)};a.remove=function(b){var d=-1;g(c,function(a){d++;if(a.file==b)return c.splice(d,1)})};return a},_getFilesDataArray:function(b){var d=[],a={};if(M.test(b&&b.tagName)){var c=k.getFiles(b);a[b.name||"file"]=null!==b.getAttribute("multiple")?c:c[0]}else w(b)&&M.test(b[0]&&b[0].tagName)?g(b,function(b){a[b.name||"file"]=k.getFiles(b)}):a=b;g(a,function z(b,a){w(b)?g(b,function(b,d){z(b,a)}):b&&b.name&&d.push({name:a,file:b,size:b.size,total:b.size,loaded:0})});
d.length||d.push({file:{name:k.expando}});return d},_getFormData:function(b,d,a){var c=d.file,h=d.name,e=c.name,u=c.type;d=k.support.transform&&b.imageTransform;var f=new k.Form,q=k.queue(function(){a(f)}),r=d&&(0<parseInt(d.maxWidth||d.minWidth||d.width,10)||d.rotate);g(b.data,function aa(b,d){"object"==typeof b?g(b,function(b,a){aa(b,k.postNameConcat(d,a))}):f.append(d,b)});k.Image&&d&&(/image/.test(c.type)||X.test(c.nodeType))?(q.inc(),r&&(d=[d]),k.Image.transform(c,d,b.imageAutoOrientation,function(d,
a){r&&!d?(N||k.flashEngine||(a[0]=k.toBinaryString(a[0]),f.multipart=!0),f.append(h,a[0],e,u)):(d||(g(a,function(b,d){N||k.flashEngine||(b=k.toBinaryString(b),f.multipart=!0);f.append(h+"["+d+"]",b,e,u)}),h+="[original]"),(d||b.imageOriginal)&&f.append(h,c,e,u));q.next()})):e!==k.expando&&f.append(h,c,e);q.check()},reset:function(b,d){var a,c;x?(c=x(b).clone(!0).insertBefore(b).val("")[0],d||x(b).remove()):(a=b.parentNode,c=a.insertBefore(b.cloneNode(!0),b),c.value="",d||a.removeChild(b),g(C[k.uid(b)],
function(d,a){g(d,function(d){p(b,a,d);s(c,a,d)})}));return c},load:function(b,d){var a=k.getXHR();a?(a.open("GET",b,!0),a.overrideMimeType&&a.overrideMimeType("text/plain; charset=x-user-defined"),s(a,"progress",function(b){b.lengthComputable&&d({type:b.type,loaded:b.loaded,total:b.total},a)}),a.onreadystatechange=function(){if(4==a.readyState)if(a.onreadystatechange=null,200==a.status){b=b.split("/");var c={name:b[b.length-1],size:a.getResponseHeader("Content-Length"),type:a.getResponseHeader("Content-Type")};
...
((b.originalEvent||b||"").dataTransfer||{}).types,e=a&&a.length;e--;)~a[e].indexOf("File")&&(b.preventDefault(),h!==b.type&&(h=b.type,"dragleave"!=h&&d.call(b.currentTarget,!0,b),clearTimeout(c),c=setTimeout(function(){d.call(b.currentTarget,"dragleave"!=h,b)},50)))}),s(b,"drop",function(b){b.preventDefault();h=0;d.call(b.currentTarget,!1,b);k.getDropFiles(b,function(d){a.call(b.currentTarget,d,b)})})):k.log("Drag'n'Drop -- not supported")};x&&!x.fn.dnd&&(x.fn.dnd=function(b,d){return this.each(function(){k.event.dnd(this,
b,d)})});a.FileAPI=k.extend(k,a.FileAPI);k.log("version: "+k.version);k.log("protocol: "+a.location.protocol);A.doctype?k.log("doctype: ["+A.doctype.name+"] "+A.doctype.publicId+" "+A.doctype.systemId):k.log("doctype: unknown");g(A.getElementsByTagName("meta"),function(b){/x-ua-compatible/i.test(b.getAttribute("http-equiv"))&&k.log("meta.http-equiv: "+b.getAttribute("content"))});k.flashUrl||(k.flashUrl=k.staticPath+"FileAPI.flash.swf");k.flashImageUrl||(k.flashImageUrl=k.staticPath+"FileAPI.flash.image.swf")})(window);
