...
function y(){d(c!=a&&y,b[a],a++)}():d(!1)},extend:function(b){g(arguments,function(d){g(d,function(d,a){b[a]=d})});return b},isFile:function(b){return l&&b&&b instanceof q},isCanvas:function(b){return b&&H.test(b.nodeName)},getFilesFilter:function(b){return(b="string"==typeof b?b:b.getAttribute&&b.getAttribute("accept")||"")?RegExp("("+b.replace(/\./g,"\\.").replace(/,/g,"|")+")$","i"):/./},readAsDataURL:function(b,d){i.isCanvas(b)?c(b,d,"load",i.toDataURL(b)):e(b,d,"DataURL")},readAsBinaryString:function(b,
d){s&&s.prototype.readAsBinaryString?e(b,d,"BinaryString"):e(b,function(b){if("load"==b.type)try{b.result=i.toBinaryString(b.result)}catch(a){b.type="error",b.message=a.toString()}d(b)},"DataURL")},readAsArrayBuffer:function(b,d){e(b,d,"ArrayBuffer")},readAsText:function(b,d,a){a||(a=d,d="utf-8");e(b,a,"Text",d)},toDataURL:function(b){if("string"==typeof b)return b;if(b.toDataURL)return b.toDataURL("image/png")},toBinaryString:function(b){return a.atob(i.toDataURL(b).replace(P,""))},readAsImage:function(b,
d,a){if(i.isFile(b))if(p){var h=p.createObjectURL(b);h===k?c(b,d,"error"):i.readAsImage(h,d,a)}else i.readAsDataURL(b,function(h){"load"==h.type?i.readAsImage(h.result,d,a):(a||"error"==h.type)&&c(b,d,h,null,{loaded:h.loaded,total:h.total})});else i.isCanvas(b)?c(b,d,"load",b):O.test(b.nodeName)?b.complete?c(b,d,"load",b):f(b,"error abort load",function y(a){"load"==a.type&&p&&p.revokeObjectURL(b.src);m(b,"error abort load",y);c(b,d,a,b)}):b.iframe?c(b,d,{type:"error"}):(h=new Image,h.src=b.dataURL||
