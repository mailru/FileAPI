...
d?(n(k,K,R),k=null):c(b,e,a,a.target.result)});try{if(d)k["readAs"+a](d,b);else k["readAs"+a](b)}catch(u){c(b,e,"error",l,{error:u.toString()})}}else c(b,e,"error",l,{error:"filreader_not_support_"+a})}function h(b){var e;b.getAsEntry?e=b.getAsEntry():b.webkitGetAsEntry&&(e=b.webkitGetAsEntry());return e}function w(b,e){if(b)if(b.isFile)b.file(function(b){e(!1,[b])},function(){e("entry_file")});else if(b.isDirectory){var a=[];b.createReader().readEntries(function(b){j.afor(b,function(b,c){w(c,function(c,
d){c||(a=a.concat(d));b?b():e(!1,a)})})},function(){e("directory_reader")})}else w(h(b),e);else e("empty_entry")}function k(b){return"object"==typeof b&&b&&"length"in b}function A(b){b.target||(b.target=a.event&&a.event.srcElement||u);3===b.target.nodeType&&(b.target=event.target.parentNode);return b}var v=1,D=function(){},q=navigator.userAgent,y=a.createObjectURL&&a||a.URL&&URL.revokeObjectURL&&URL||a.webkitURL&&webkitURL,r=a.File,t=a.FileReader,p=a.FormData,s=a.jQuery,e=!(!r||!(t&&a.Uint8Array||
p))&&!(/safari\//.test(q)&&/windows/i.test(q)),q=e&&"withCredentials"in new XMLHttpRequest,p=e&&!!Blob&&!(!Blob.prototype.webkitSlice&&!Blob.prototype.mozSlice&&!Blob.prototype.slice),u=a.document,x=a.dataURLtoBlob,T=/img/i,E=/canvas/i,U=/img|canvas/,L=/input/i,V=/^data:[^,]+,/,C=Math.pow,G=Math.round,H=Number,I=function(b){return G(b*this)},F=new H(1024),N=new H(C(F,2)),O=new H(C(F,3)),C=new H(C(F,4)),z={},P=[],K="abort progress error load loadend",W="status statusText readyState response responseXML responseText responseBody".split(" "),
...
console.log.apply(console,arguments):console.log([].join.call(arguments," ")))},getXHR:function(){var b;if(a.XMLHttpRequest)b=new XMLHttpRequest;else if(a.ActiveXObject)try{b=new ActiveXObject("MSXML2.XMLHttp.3.0")}catch(e){}return b},isArray:k,support:{dnd:q&&"ondrop"in u.createElement("div"),cors:q,html5:e,chunked:p,dataURI:!0},event:{on:m,off:n,one:f,fix:A},throttle:function(b,e){var c,d;return function(){d=arguments;c||(b.apply(a,d),c=setTimeout(function(){c=0;b.apply(a,d)},e))}},F:function(){},
...
isFail:function(){return c},fail:function(){!c&&b(c=!0)},end:function(){d||(d=!0,b())}};return k},each:g,afor:function(b,e){var a=0,c=b.length;k(b)&&c--?function B(){e(c!=a&&B,b[a],a++)}():e(!1)},extend:function(b){g(arguments,function(e){g(e,function(e,a){b[a]=e})});return b},isFile:function(b){return e&&b&&b instanceof r},isCanvas:function(b){return b&&E.test(b.nodeName)},getFilesFilter:function(b){return(b="string"==typeof b?b:b.getAttribute&&b.getAttribute("accept")||"")?RegExp("("+b.replace(/\./g,
...
typeof b)return b;if(b.toDataURL)return b.toDataURL("image/png")},toBinaryString:function(b){return a.atob(j.toDataURL(b).replace(V,""))},readAsImage:function(b,e,a){if(j.isFile(b))if(y){var d=y.createObjectURL(b);d===l?c(b,e,"error"):j.readAsImage(d,e,a)}else j.readAsDataURL(b,function(d){"load"==d.type?j.readAsImage(d.result,e,a):(a||"error"==d.type)&&c(b,e,d,null,{loaded:d.loaded,total:d.total})});else j.isCanvas(b)?c(b,e,"load",b):T.test(b.nodeName)?b.complete?c(b,e,"load",b):f(b,"error abort load",
function B(a){"load"==a.type&&y&&y.revokeObjectURL(b.src);n(b,"error abort load",B);c(b,e,a,b)}):b.iframe?c(b,e,{type:"error"}):(d=new Image,d.src=b.dataURL||b,j.readAsImage(d,e,a))},checkFileObj:function(b){var e={},a=j.accept;"object"==typeof b?e=b:e.name=(b+"").split(/\\|\//g).pop();null==e.type&&(e.type=e.name.split(".").pop());g(a,function(b,a){b=RegExp(b.replace(/\s/g,"|"),"i");b.test(e.type)&&(e.type=a.split("/")[0]+"/"+e.type)});return e},getDropFiles:function(b,e){var a=[],c=(b.originalEvent||
b||"").dataTransfer||{},d=k(c.items)&&c.items[0]&&h(c.items[0]),u=j.queue(function(){e(a)});g((d?c.items:c.files)||[],function(b){u.inc();if(d)w(b,function(b,e){!b&&a.push.apply(a,e);u.next()});else{var e=function(e){e&&a.push(b);u.next()};if(!b.type&&0==b.size%4096&&102400>=b.size)if(t)try{var c=new t;f(c,K,function(b){b="error"!=b.type;e(b);b&&c.abort()});c.readAsDataURL(b)}catch(k){e(!1)}else e(null);else e(!0)}});u.check()},getFiles:function(b,a,c){var d=[];if(c)return j.filterFiles(j.getFiles(b),
...
j.extend({prepare:j.F,beforeupload:j.F,upload:j.F,fileupload:j.F,fileprogress:j.F,filecomplete:j.F,progress:j.F,complete:j.F,pause:j.F,chunkSize:j.chunkSize,chunkUpoloadRetry:j.chunkUploadRetry},b);b.imageAutoOrientation&&!b.imageTransform&&(b.imageTransform={rotate:"auto"});var e=new j.XHR(b),a=this._getFilesDataArray(b.files),c=0,d=0,k=0,u=1,w=this,f,x=!1;g(a,function(b){c+=b.size});e.files=[];g(a,function(b){e.files.push(b.file)});e.total=c;e.loaded=0;b.beforeupload(e,b);(f=function M(){var f=
a.shift(),h=f&&f.file,n=!1,v={};g(b,function(b,e){b&&"object"===typeof b&&(b=j.extend({},b));v[e]=b});("abort"!=e.statusText||e.current)&&f?(x=!1,e.currentFile=h,b.prepare(h,v),this._getFormData(v,f,function(a){d||b.upload(e,b);var x=new j.XHR(j.extend({},v,{upload:function(){b.fileupload(h,x,v)},progress:function(a){n||(k=d+=c*u*(a.loaded/a.total)-k+0.5|0,f.total=a.total,f.loaded=a.loaded,b.fileprogress(a,h,x,v),b.progress({type:a.type,total:c,loaded:e.loaded=d,lengthComputable:!0},h,x,v))},complete:function(a){g(W,
function(b){e[b]=x[b]});n=!0;f.loaded=f.total;e.loaded=d+=d-k+(c*u+0.5)|0;b.filecomplete(a,x,h,v);M.call(w)}}));u=f.size/c;e.abort=function(b){this.current=b;x.abort()};x.send(a)})):(b.complete(200==e.status||201==e.status?!1:e.statusText||"error",e,b),x=!0)}).call(this);e.append=function(b){b=j._getFilesDataArray([].concat(b));g(b,function(b){c+=b.size;e.files.push(b.file);a.push(b)});x&&f.call(w)};e.remove=function(b){var e=-1;g(a,function(c){e++;if(c.file==b)return a.splice(e,1)})};return e},_getFilesDataArray:function(b){var e=
[],a={};if(L.test(b&&b.tagName)){var c=j.getFiles(b);a[b.name||"file"]=null!==b.getAttribute("multiple")?c:c[0]}else k(b)&&L.test(b[0]&&b[0].tagName)?g(b,function(b){a[b.name||"file"]=j.getFiles(b)}):a=b;g(a,function B(b,a){k(b)?g(b,function(b){B(b,a)}):b&&b.name&&e.push({name:a,file:b,size:b.size,total:b.size,loaded:0})});return e},_getFormData:function(b,e,a){var c=e.file,d=e.name,k=c.name,u=c.type;e=j.support.transform&&b.imageTransform;var f=new j.Form,w=j.queue(function(){a(f)}),h=e&&(0<parseInt(e.maxWidth||
e.minWidth||e.width,10)||e.rotate);j.Image&&e&&(/image/.test(c.type)||U.test(c.nodeType))?(w.inc(),h&&(e=[e]),j.Image.transform(c,e,b.imageAutoOrientation,function(e,a){h&&!e?(!x&&!j.flashEngine&&(a[0]=j.toBinaryString(a[0]),f.multipart=!0),f.append(d,a[0],k,u)):(e||(g(a,function(b,e){!x&&!j.flashEngine&&(b=j.toBinaryString(b),f.multipart=!0);f.append(d+"["+e+"]",b,k,u)}),d+="[original]"),(e||b.imageOriginal)&&f.append(d,c,k,u));w.next()})):f.append(d,c,k);g(b.data,function M(b,e){"object"==typeof b?
g(b,function(b,a){M(b,e+"["+a+"]")}):f.append(e,b)});w.check()},reset:function(b){var e,a;s?(a=s(b).clone(!0).insertBefore(b).val("")[0],s(b).remove()):(e=b.parentNode,a=e.insertBefore(b.cloneNode(!0),b),a.value="",e.removeChild(b),g(z[j.uid(b)],function(e,c){g(e,function(e){n(b,c,e);m(a,c,e)})}));return a},load:function(b,e){var a=j.getXHR();a?(a.open("GET",b,!0),a.overrideMimeType&&a.overrideMimeType("text/plain; charset=x-user-defined"),m(a,"progress",function(b){b.lengthComputable&&e({type:b.type,
...
c,d){"string"==typeof c&&(d=c,c=a);return this.set({dw:a,dh:c,resize:d})},preview:function(a,c){return this.set({dw:a,dh:c||a,resize:"preview"})},rotate:function(a){return this.set({deg:a})},_load:function(c,d){var f=this;a.readAsImage(c,function(a){d.call(f,"load"!=a.type,a.result)})},_apply:function(a,c){var d=l.createElement("canvas"),f=this.getMatrix(a),g=d.getContext("2d"),h=f.deg,n=f.dw,r=f.dh,t=a.width,p=a.height,s,e=a;if(this.better)for(;2<Math.min(t/n,p/r);)t=~~(t/2+0.5),p=~~(p/2+0.5),s=
l.createElement("canvas"),s.width=t,s.height=p,e!==a?(s.getContext("2d").drawImage(e,0,0,e.width,e.height,0,0,t,p),e=s):(e=s,e.getContext("2d").drawImage(a,f.sx,f.sy,f.sw,f.sh,0,0,t,p),f.sx=f.sy=f.sw=f.sh=0);d.width=!(h%180)?n:r;d.height=h%180?n:r;g.rotate(h*Math.PI/180);g.drawImage(e,f.sx,f.sy,f.sw||e.width,f.sh||e.height,180==h||270==h?-n:0,90==h||180==h?-r:0,n,r);c.call(this,!1,d)},getMatrix:function(c){var d=a.extend({},this.matrix),h=d.sw=d.sw||c.width;c=d.sh=d.sh||c.height;var g=d.dw=d.dw||
d.sw,l=d.dh=d.dh||d.sh,q=h/c,m=g/l,r=d.resize;if("preview"==r){if(g!=h||l!=c)if(m>=q?(q=h,r=q/m):(r=c,q=r*m),q!=h||r!=c)d.sx=~~((h-q)/2),d.sy=~~((c-r)/2),h=q,c=r}else r&&("min"==r?(g=f(q<m?n(h,g):l*q),l=f(q<m?g/q:n(c,l))):(g=f(q>=m?n(h,g):l*q),l=f(q>=m?g/q:n(c,l))));d.sw=h;d.sh=c;d.dw=g;d.dh=l;return d},_trans:function(a){this._load(this.file,function(c,d){c?a(c):this._apply(d,a)})},get:function(c){if(a.support.transform){var f=this;"auto"==f.matrix.deg?a.getInfo(this.file,function(a,h){f.matrix.deg=
d[h&&h.exif&&h.exif.Orientation]||0;f._trans(c)}):f._trans(c)}else c("not_support")},toData:function(a){this.get(a)}};m.exifOrientation=d;m.transform=function(c,d,f,h){a.getInfo(c,function(n,l){var y={},r=a.queue(function(a){h(a,y)});n?r.fail():a.each(d,function(a,d){if(!r.isFail()){var k=m(l.nodeType?l:c);if("function"==typeof a)a(l,k);else if(a.width)k[a.preview?"preview":"resize"](a.width,a.height,a.type);else a.maxWidth&&(l.width>a.maxWidth||l.height>a.maxHeight)&&k.resize(a.maxWidth,a.maxHeight,
"max");a.rotate===g&&f&&(a.rotate="auto");k.rotate(a.rotate);r.inc();k.toData(function(a,c){a?r.fail():(y[d]=c,r.next())})}})})};a.support.canvas=a.support.transform=c;a.Image=m})(FileAPI,document);
...
a.support.transform=!0;k(a,{getFiles:function(e,c,d){if(d)return a.filterFiles(a.getFiles(e),c,d),null;var f=a.isArray(e)?e:r[a.uid(e.target||e.srcElement||e)];if(!f)return this.parent.apply(this,arguments);c&&(c=a.getFilesFilter(c),f=a.filter(f,function(a){return c.test(a.name)}));return f},getInfo:function(e,c){if(e&&!e.flashId)this.parent.apply(this,arguments);else{if(!e.__info){var d=e.__info=a.defer();p.cmd(e,"getFileInfo",{id:e.id,callback:A(function E(a,c){v(E);d.resolve(a,e.info=c)})})}e.__info.then(c)}}});
a.support.transform=!0;a.Image&&k(a.Image.prototype,{get:function(a,c){this.set({scaleMode:c||"noScale"});this.parent(a)},_load:function(e,c){a.log("FileAPI.Image._load:",e);if(e&&!e.flashId)this.parent.apply(this,arguments);else{var d=this;a.getInfo(e,function(a){c.call(d,a,e)})}},_apply:function(e,c){a.log("FileAPI.Image._apply:",e);if(e&&!e.flashId)this.parent.apply(this,arguments);else{var d=this.getMatrix(e.info);p.cmd(e,"imageTransform",{id:e.id,matrix:d,callback:A(function E(f,k){a.log("FileAPI.Image._apply.callback:",
f);v(E);if(f)c(f);else if(!a.support.dataURI||3E4<k.length){var l={width:!(d.deg%180)?d.dw:d.dh,height:d.deg%180?d.dw:d.dh,scale:d.scaleMode},m=c,n=function(){try{p.get(r).setImage(k)}catch(c){a.log('flash.setImage -- can not set "base64":',c)}},q,r=a.uid(),s=g.createElement("div");for(q in l)s.setAttribute("data-img-"+q,l[q]);w(s,l);s.innerHTML=h(a.extend({id:r,src:D(a.flashImageUrl,"r="+a.uid()),wmode:"opaque",flashvars:"scale="+l.scale+"&callback="+A(function z(){v(z);setTimeout(n,99);return!0})},
l));m(!1,s);s=null}else{var t=new Image;a.event.one(t,"error abort load",function(a){c("load"!=a.type&&a.type,t);t=null});t.src="data:"+e.type+";base64,"+k}})})}},toData:function(c){var d=this.file,f=d.info,g=this.getMatrix(f);d&&!d.flashId?this.parent.apply(this,arguments):("auto"==g.deg&&(g.deg=a.Image.exifOrientation[f&&f.exif&&f.exif.Orientation]||0),c.call(this,!d.info,{id:d.id,flashId:d.flashId,name:d.name,type:d.type,matrix:g}))}});k(a.Form.prototype,{toData:function(c){for(var d=this.items,
f=d.length;f--;)if(d[f].file&&d[f].blob&&!d[f].blob.flashId)return this.parent.apply(this,arguments);a.log("flash.Form.toData");c(d)}});k(a.XHR.prototype,{_send:function(c,d){if(d.nodeName||d.append&&a.support.html5||a.isArray(d)&&"string"===typeof d[0])return this.parent.apply(this,arguments);var f={},g={},h=this,k,l;a.each(d,function(a){a.file?(g[a.name]=a={id:a.blob.id,name:a.blob.name,matrix:a.blob.matrix,flashId:a.blob.flashId},l=a.id,k=a.flashId):f[a.name]=a.blob});a.log("flash.XHR._send:",
k,l,g);h.xhr={headers:{},abort:function(){p.cmd(k,"abort",{id:l})},getResponseHeader:function(a){return this.headers[a]},getAllResponseHeaders:function(){return this.headers}};var m=a.queue(function(){p.cmd(k,"upload",{url:D(c.url),data:f,files:g,headers:c.headers,callback:A(function G(d){var f=d.type,g=d.result;a.log("flash.upload."+f+":",d);if("progress"==f)d.loaded=Math.min(d.loaded,d.total),d.lengthComputable=!0,c.progress(d);else if("complete"==f)v(G),"string"==typeof g&&(h.responseText=g.replace(/%22/g,
'"').replace(/%5c/g,"\\").replace(/%26/g,"&").replace(/%25/g,"%")),h.end(d.status||200);else if("abort"==f||"error"==f)h.end(d.status||0,d.message),v(G)})})});a.each(g,function(c){m.inc();a.getInfo(c,m.next)});m.check()}})}};a.Flash=p;var s=new Image;a.event.one(s,"error load",function(){a.support.dataURI=!(1!=s.width||1!=s.height);s=null;p.init()});s.src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw=="}})(FileAPI,window,document);"undefined"!==typeof ajs&&ajs.loaded&&ajs.loaded("{fileapi}FileAPI.min");
