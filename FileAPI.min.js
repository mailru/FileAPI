...
e,a);else{for(var K=d[e]||[],c=K.length;c--;)if(K[c]===a){K.splice(c,1);break}b.addEventListener?b.removeEventListener(e,a,!1):b.detachEvent?b.detachEvent("on"+e,a):b["on"+e]=null}})}}function f(b,e,a){q(b,e,function Q(c){l(b,e,Q);a(c)})}function c(b,e,a,c,d){b={type:a.type||a,target:b,result:c};h.extend(b,d);e(b)}function d(b,e,a,d){if(h.isFile(b)&&u&&u.prototype["readAs"+a]){var j=new u;q(j,L,function R(a){var d=a.type;"progress"==d?c(b,e,a,a.target.result,{loaded:a.loaded,total:a.total}):"loadend"==
d?(l(j,L,R),j=null):c(b,e,a,a.target.result)});try{if(d)j["readAs"+a](d,b);else j["readAs"+a](b)}catch(w){c(b,e,"error",k,{error:w.toString()})}}else c(b,e,"error",k,{error:"filreader_not_support_"+a})}function m(b){var e;b.getAsEntry?e=b.getAsEntry():b.webkitGetAsEntry&&(e=b.webkitGetAsEntry());return e}function p(b,e){if(b)if(b.isFile)b.file(function(b){e(!1,[b])},function(){e("entry_file")});else if(b.isDirectory){var a=[];b.createReader().readEntries(function(b){h.afor(b,function(b,c){p(c,function(c,
...
n))&&!(/safari\//.test(s)&&/windows/i.test(s)),s=e&&"withCredentials"in new XMLHttpRequest,n=e&&!!Blob&&!(!Blob.prototype.webkitSlice&&!Blob.prototype.mozSlice&&!Blob.prototype.slice),w=a.document,y=a.dataURLtoBlob,N={},E=/img/i,S=/canvas/i,T=/img|canvas/,G=/input/i,U=/^data:[^,]+,/,z=Math.pow,V=Math.round,H=Number,I=function(b){return V(b*this)},F=new H(1024),O=new H(z(F,2)),J=new H(z(F,3)),z=new H(z(F,4)),C={},P=[],L="abort progress error load loadend",W="status statusText readyState response responseXML responseText responseBody".split(" "),
h={version:"1.2.2",cors:!1,debug:!1,pingUrl:!1,staticPath:"./",flashUrl:0,flashImageUrl:0,chunkSize:0,chunkUploadRetry:0,KB:(F.from=I,F),MB:(O.from=I,O),GB:(J.from=I,J),TB:(z.from=I,z),expando:"fileapi"+(new Date).getTime(),uid:function(b){return b?b[h.expando]=b[h.expando]||h.uid():(++v,h.expando+v)},log:function(){h.debug&&(a.console&&console.log)&&(console.log.apply?console.log.apply(console,arguments):console.log([].join.call(arguments," ")))},getXHR:function(){var b;if(a.XMLHttpRequest)b=new XMLHttpRequest;
...
b,h.readAsImage(d,e,a))},checkFileObj:function(b){var e={};"object"==typeof b?e=b:e.name=(b+"").split(/(\\|\/)/g).pop();e.type===k&&(e.type=e.name.split(".").pop());g(N,function(b,a){b.test(e.type)&&(e.type=a+"/"+e.type)});return e},getDropFiles:function(b,e){var a=[],c=(b.originalEvent||b||"").dataTransfer||{},d=j(c.items)&&c.items[0]&&m(c.items[0]),w=h.queue(function(){e(a)});g((d?c.items:c.files)||[],function(b){w.inc();if(d)p(b,function(b,e){!b&&a.push.apply(a,e);w.next()});else{var e=function(e){e&&
