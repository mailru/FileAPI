...
new XMLHttpRequest:null;d?(f.getResponseHeader=function(a){return d.getResponseHeader(a)},f.getAllResponseHeaders=function(){return d.getAllResponseHeaders()},f.abort=function(a){f.statusText=a||"abort";d.abort(a);h(0,f)},e?c.each(i,function(a,d){l(a)?c.each(a,function(a){b.append(d,a)}):b.append(d,a)}):(c.each(i,function(a,d){l(a)?c.each(a,function(a){b+="--"+j+s(d,a)}):b+="--"+j+s(d,a)}),b+="--"+j+"--",d.send=d.sendAsBinary||function(a){return function(b){b=Array.prototype.map.call(b,function(a){return a.charCodeAt(0)&
